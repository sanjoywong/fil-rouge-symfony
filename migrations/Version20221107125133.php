 ...
 */
final class Version20221107125133 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cours (id INT AUTO_INCREMENT NOT NULL, salle_id INT DEFAULT NULL, promotion_id INT DEFAULT NULL, enseigant_id INT DEFAULT NULL, date DATE NOT NULL, heure_debut TIME NOT NULL, heure_fin TIME NOT NULL, nom_matiere VARCHAR(255) DEFAULT NULL, INDEX IDX_FDCA8C9C8CEBACA0 (salle_id), INDEX IDX_FDCA8C9C305C84E6 (promotion_id), INDEX IDX_FDCA8C9CF88F188A (enseigant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
